...
tout d'abord, j'ai du prendre httptools 0.6.4 car sinon j'ai l'erreur "failed building wheel" lors de l'installation.
...
First of all, I had to use httptools 0.6.4 because otherwise, I got the "failed building wheel" error during installation.
